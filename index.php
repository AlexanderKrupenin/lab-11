...
<body>
    <header>
        <div id="main_menu" class ="button_main"><?php 
...
function footer_big(){
    echo'</main>
    <footer><div class="button_main" style = "position: absolute; left: 0%;top:220%; width: 96%; height: 20%; color:black">';
...
function footer_small(){
    echo'</main>
    <footer><div class="button_main" style = "position: absolute; left: 0%;top:80%; width: 96%; height: 20%; color:black">';
    //echo''.$_GET['html_type'].'<br>';
    if( !isset($_GET['html_type']) || $_GET['html_type'] === 'TABLE') 
        $s='Табличная верстка. '; // строка с информацией 
    else 
